...
wp_enqueue_script("script-kenburns-gallery", get_stylesheet_directory_uri()."/templates/script-kenburns-gallery.php?gallery_id=".$gallery_id, false, THEMEVERSION, true);
