...
wp_enqueue_style("jqueryui", get_stylesheet_directory_uri()."/css/jqueryui/custom.css", false, THEMEVERSION, "all");
...
wp_enqueue_script("jquery-ui", $file_dir."/functions/jquery-ui/js/jquery-ui-1.9.2.custom.min.js", false, THEMEVERSION);
...
function pp_enqueue_front_page_styles() {
	...
	{
		wp_enqueue_style("ie.css", get_stylesheet_directory_uri()."/css/ie.css", false, THEMEVERSION, "all");
	}
