...
wp_enqueue_script("script-carousel-gallery", get_stylesheet_directory_uri()."/templates/script-carousel-gallery.php?gallery_id=".$gallery_id, false, THEMEVERSION, true);
?>
