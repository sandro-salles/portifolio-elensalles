...
wp_enqueue_script("script-flow-gallery", get_stylesheet_directory_uri()."/templates/script-flow-gallery-portfolio.php?gallery_id=".$portfolio_gallery_id, false, THEMEVERSION, true);
?>
